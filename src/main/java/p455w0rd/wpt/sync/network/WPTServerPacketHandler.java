...
public final class WPTServerPacketHandler extends WPTPacketHandlerBase implements IPacketHandler {

	private static final WPTServerPacketHandler INSTANCE = new WPTServerPacketHandler();

	public static final WPTServerPacketHandler instance() {
		return INSTANCE;
	}
